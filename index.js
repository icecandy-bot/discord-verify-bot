...
// --- 驗證檢查（Discord 專用：須同時通過 kills 與 robloxVerified） ---
...
app.get("/", (req, res) => {
  // 每次刷新首頁都建立 / 更新一個測試 session
  sessions.set("test", {
    playerName: "DemoPlayer",
    state: "test",
    kills: 5000, // 測試值，≥3000
    robloxVerified: false,
    channelId: null, // 無 Discord 頻道
...
// --- Health check（給 UptimeRobot/Render） ---
